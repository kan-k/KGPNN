...
write_feather(as.data.frame(bases.nb),paste0("/well/nichols/users/qcv214/KGPNN/res4_partial_gp_centroids_fixed_",poly_degree,a_concentration,b_smoothness,".feather"))
