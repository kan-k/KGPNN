...
#29 Feb: implement RCPP for longer run
...
filename <- "feb29_bimodal_rcpp_gpnn_bbig_init"
...
write_feather(as.data.frame(min.weights.dmn),paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_minweightsdmn_',"_jobid_",JobId,'.feather'))
