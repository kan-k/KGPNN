...
filename <- "mar1_bimodal_rcpp_gpnn_bbig_init_bbs" 
success.run <- c(2,3,5:10)
...
##########
print("weights1")
weights <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minweights__jobid_',init.num,'.feather')))
print("weights2")
weights.dmn<- as.matrix(read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minweightsdmn__jobid_",init.num,".csv")))
# weights.dmn <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minweightsdmn__jobid_',init.num,'.feather')))
...
alpha.init <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minalpha__jobid_",init.num,".csv"))$x #shape
beta.init <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minbeta__jobid_",init.num,".csv"))$x #scale
print("alpha-beta2")

alpha.init.dmn <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minalphadmn__jobid_",init.num,".csv"))$x #shape
beta.init.dmn <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minbetadmn__jobid_",init.num,".csv"))$x #scale
...
prior.var <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minpriorvar__jobid_",init.num,".csv"))$x#Mean of IG
print("prior var2")

prior.var.dmn <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minpriorvardmn__jobid_",init.num,".csv"))$x#Mean of IG

#Fix prior var to be 0.1
# prior.var <- 1.5
print("sigma")

y.sigma <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minsigma__jobid_",init.num,".csv"))$x
y.sigma.vec <- y.sigma
...
print("bias1")
bias <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minbias__jobid_",init.num,".csv"))$x
print("bias2")

bias.dmn <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_feb29_bimodal_rcpp_gpnn_bbig_init_minbiasdmn__jobid_",init.num,".csv"))$x
