...
filename <- "oct2_gender_nn_bbig_init"
...
write_feather(as.data.frame(c(hs_fit_SOI$post_mean$betacoef[2:(n.mask+1)],hs_fit_SOI$post_mean$betacoef[n.mask+2],hs_fit_SOI$post_mean$betacoef[-1:-(n.mask+2)] )),paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_lweights_',"_jobid_",JobId,'.feather'))
