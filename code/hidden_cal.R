...
filename <- "dec11_testhidden_sm_gpnn_bbig_init_bbs" 
...
weights9 <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_dec9_sm_gpnn_bbig_init_bbs_weights__jobid_',9,'.feather')))
weights10 <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_dec9_sm_gpnn_bbig_init_bbs_weights__jobid_',10,'.feather')))
weights6 <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_dec9_sm_gpnn_bbig_init_bbs_weights__jobid_',6,'.feather')))

#Initialising bias (to 0)
bias9 <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_dec9_sm_gpnn_bbig_init_bbs_bias__jobid_",9,".csv"))$x
bias10 <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_dec9_sm_gpnn_bbig_init_bbs_bias__jobid_",9,".csv"))$x
bias6 <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_dec9_sm_gpnn_bbig_init_bbs_bias__jobid_",9,".csv"))$x
...
write_feather(as.data.frame(hidden.layer9),paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_hidden9_',"_jobid_",JobId,'.feather'))
write_feather(as.data.frame(hidden.layer10),paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_hidden10_',"_jobid_",JobId,'.feather'))
write_feather(as.data.frame(hidden.layer6),paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_hidden6_',"_jobid_",JobId,'.feather'))
