...
filename <- "oct6_female_nogender_gpnn_bbig_init_bbs"
...
train.test.ind2 <- list()
train.test.ind2$test <- read.csv('/well/nichols/users/qcv214/KGPNN/sex_test_index.csv')$x
train.test.ind2$train <-  read.csv('/well/nichols/users/qcv214/KGPNN/sex_train_index.csv')$x



train.test.ind <- list()
train.test.ind$test <- train.test.ind2$test[which(sex[train.test.ind2$test] == -1)]
train.test.ind$train <-  train.test.ind2$train[which(sex[train.test.ind2$train] == -1)]
...
alpha.init <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_oct5_female_nogender_gpnn_bbig_init_minalpha__jobid_",init.num,".csv"))$x #shape
beta.init <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_oct5_female_nogender_gpnn_bbig_init_minbeta__jobid_",init.num,".csv"))$x #scale
...
#Define init var
prior.var <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_oct5_female_nogender_gpnn_bbig_init_minpriorvar__jobid_",init.num,".csv"))$x#Mean of IG

#Fix prior var to be 0.1
# prior.var <- 1.5
y.sigma <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_oct5_female_nogender_gpnn_bbig_init_minsigma__jobid_",init.num,".csv"))$x
y.sigma.vec <- y.sigma
...
weights <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_oct5_female_nogender_gpnn_bbig_init_minweights__jobid_',init.num,'.feather')))

#Initialising bias (to 0)
bias <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/pile/re_oct5_female_nogender_gpnn_bbig_init_minbias__jobid_",init.num,".csv"))$x
time.train <-  Sys.time()
