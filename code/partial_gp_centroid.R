...
coord.centroid <- as.matrix(read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/coord_centroids.csv")))
#Use coord.centroid[,5:7] for transformed coord


#Get partial GP
#param:
poly_degree = 1#3#10#30 has been used 
a_concentration = 0.5
b_smoothness = 40
dimension = 3
#get psi
...
write_feather(as.data.frame(bases.nb),paste0("/well/nichols/users/qcv214/KGPNN/partial_gp_centroids_fixed_",poly_degree,a_concentration,b_smoothness,".feather"))
