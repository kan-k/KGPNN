...
filename <- "sep29_nogender_gpgp_bbig_init"
...
# apply(partial.gp,MARGIN = 1,mult.dat)
###################This is to test if wrong
...
for(i in 1:n.mask){
  theta.matrix[i,] <- rnorm(n.expan,0,sqrt(prior.var*y.sigma)) #IT WAS 500
