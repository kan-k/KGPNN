...
#30 Jan: including both structural and Default Mode Network
##Important notes: Assume Structural and DMN uses the same mask and GP expansion.
...
filename <- "feb1_bimodal_gpnn_bbig_init"
...
write_feather(as.data.frame(weights.dmn),paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_weightsdmn_',"_jobid_",JobId,'.feather'))
...
write.csv(min.weights.dmn,paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_minweightsdmn_',"_jobid_",JobId,".csv"), row.names = FALSE)
write.csv(min.bias.dmn,paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_minbiasdmn_',"_jobid_",JobId,".csv"), row.names = FALSE)
write.csv(min.alpha.dmn,paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_minalphadmn_',"_jobid_",JobId,".csv"), row.names = FALSE)
write.csv(min.beta.dmn,paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_minbetadmn_',"_jobid_",JobId,".csv"), row.names = FALSE)
write.csv(min.prior.var.dmn,paste0( '/well/nichols/users/qcv214/KGPNN/pile/re_',filename,'_minpriorvardmn_',"_jobid_",JobId,".csv"), row.names = FALSE)
