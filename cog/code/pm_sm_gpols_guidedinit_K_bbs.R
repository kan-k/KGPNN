...
filename <- "oct26_pm_sm_gpols_guidedinit_bbs" 
success.run <- 1:10
...
for(num.lat.class.select in c(2)){
  ...
  alpha.init <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/cog/pile/re_oct26_pm_sm_gpols_guidedinit",'_K',num.lat.class.select,"_minalpha__jobid_",init.num,".csv"))$x #shape
  beta.init <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/cog/pile/re_oct26_pm_sm_gpols_guidedinit",'_K',num.lat.class.select,"_minbeta__jobid_",init.num,".csv"))$x #scale
  ...
  #Define init var
  prior.var <-  read.csv(paste0("/well/nichols/users/qcv214/KGPNN/cog/pile/re_oct26_pm_sm_gpols_guidedinit",'_K',num.lat.class.select,"_minpriorvar__jobid_",init.num,".csv"))$x#Mean of IG
  
  #Fix prior var to be 0.1
  # prior.var <- 1.5
  y.sigma <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/cog/pile/re_oct26_pm_sm_gpols_guidedinit",'_K',num.lat.class.select,"_minsigma__jobid_",init.num,".csv"))$x
  y.sigma.vec <- y.sigma
  ...
  theta.matrix <- as.matrix(read_feather(paste0( "/well/nichols/users/qcv214/KGPNN/cog/pile/re_oct26_pm_sm_gpols_guidedinit",'_K',num.lat.class.select,"_mintheta__jobid_",init.num,'.feather')))
  co.weights<- as.matrix(read.csv(paste0("/well/nichols/users/qcv214/KGPNN/cog/pile/re_oct26_pm_sm_gpols_guidedinit",'_K',num.lat.class.select,"_mincoweights__jobid_",init.num,".csv")))
  
  #Initialising bias (to 0)
  bias <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/cog/pile/re_oct26_pm_sm_gpols_guidedinit",'_K',num.lat.class.select,"_minbias__jobid_",init.num,".csv"))$x
  co.bias <- read.csv(paste0("/well/nichols/users/qcv214/KGPNN/cog/pile/re_oct26_pm_sm_gpols_guidedinit",'_K',num.lat.class.select,"_mincobias__jobid_",init.num,".csv"))$x
