...
write.csv(weights.dmn,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/re_',filename,'_weightsdmn_',"_jobid_",JobId,".csv"), row.names = FALSE)
...
#inv gamme param
write.csv(conj.alpha.dmn,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/re_',filename,'_alphadmn_',"_jobid_",JobId,".csv"), row.names = FALSE)
write.csv(conj.beta.dmn,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/re_',filename,'_betadmn_',"_jobid_",JobId,".csv"), row.names = FALSE)
write.csv(conj.invgamma.dmn,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/re_',filename,'_invgamdmn_',"_jobid_",JobId,".csv"), row.names = FALSE)
