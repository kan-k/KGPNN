...
filename <- "sep29_pm_sm_gpols_pred_amp"
...
for(num.lat.class.select in c(2,4)){
  ...
  #Write Minimum 
  write.csv(min.mse,paste0("/well/nichols/users/qcv214/KGPNN/cog/pile/sim_",filename,'_K',num.lat.class.select,"_minloss_","_jobid_",JobId,".csv"), row.names = FALSE)
  write_feather(as.data.frame(min.theta.matrix),paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/sim_',filename,'_K',num.lat.class.select,'_mintheta_',"_jobid_",JobId,'.feather'))
  write.csv(min.bias,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/sim_',filename,'_K',num.lat.class.select,'_minbias_',"_jobid_",JobId,".csv"), row.names = FALSE)
  write.csv(min.y.sigma,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/sim_',filename,'_K',num.lat.class.select,'_minsigma_',"_jobid_",JobId,".csv"), row.names = FALSE)
  write.csv(min.lr,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/sim_',filename,'_K',num.lat.class.select,'_minlr_',"_jobid_",JobId,".csv"), row.names = FALSE)
  write.csv(min.alpha,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/sim_',filename,'_K',num.lat.class.select,'_minalpha_',"_jobid_",JobId,".csv"), row.names = FALSE)
  write.csv(min.beta,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/sim_',filename,'_K',num.lat.class.select,'_minbeta_',"_jobid_",JobId,".csv"), row.names = FALSE)
  write.csv(min.prior.var,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/sim_',filename,'_K',num.lat.class.select,'_minpriorvar_',"_jobid_",JobId,".csv"), row.names = FALSE)
  write.csv(min.co.weights,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/sim_',filename,'_K',num.lat.class.select,'_mincoweights_',"_jobid_",JobId,".csv"), row.names = FALSE)
  write.csv(min.co.bias,paste0( '/well/nichols/users/qcv214/KGPNN/cog/pile/sim_',filename,'_K',num.lat.class.select,'_mincobias_',"_jobid_",JobId,".csv"), row.names = FALSE)
