...
filename <- "oct30_pm_sm_gpnn_12init_bbs"
...
for(num.lat.class.select in c(2)){
  ...
  min.weights <- as.matrix(read_feather(paste0( "/well/nichols/users/qcv214/KGPNN/cog/pile/re_",filename,"_minweights__jobid_",init.num,'.feather')))
